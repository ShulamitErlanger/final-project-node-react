...
// const register = (e) => {
//    // e.preventDefault();
//     registerFunc({username:username.current.value,password:password.current.value,name:name.current.value,birthDate:birthDate.current.value,email:email.current.value,gender:gender.current.value,sector:sector.current.value})
...
const register = (e) => {
   // e.preventDefault();
    registerFunc({username:username.current.value,password:password.current.value,name:name.current.value,birthDate:birthDate.current.value,email:email.current.value,sex:sex.current.value,sector:sector.current.value})
